                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                          ...
                                          <a href="pelanggan_hapus.php?id_member=<?= $data_member['id_member']; ?>" onclick="return confirm('Apakah anda yakin menghapus data ini?');" data-toggle="tooltip" data-placement="bottom" title="Delete" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
