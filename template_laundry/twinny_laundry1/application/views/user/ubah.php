                    ...
                    <div class="col-md-12">
                        <form method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" id="nama" class="form-control" placeholder="Nama" required="" value="<?php echo $user['nama'] ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="role" id="role" class="form-control" required="">
                                    <option <?php echo $user['role'] == '' ? 'selected' : '' ?> value="">Pilih Role</option>
