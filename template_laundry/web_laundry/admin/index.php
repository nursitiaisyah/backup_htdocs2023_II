...
require 'header.php';
$jTransaksi = ambilsatubaris($koneksi,'SELECT COUNT(id_transaksi) as jumlahtransaksi FROM transaksi');
$jPelanggan = ambilsatubaris($koneksi,'SELECT COUNT(id_member) as jumlahmember FROM member');
$joutlet = ambilsatubaris($koneksi,'SELECT COUNT(id_outlet) as jumlahoutlet FROM outlet');
