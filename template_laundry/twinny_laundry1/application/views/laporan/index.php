                             ...
                             <div class="row">
                                 <div class="col-md-6">
                                     ...
                                     <div class="form-group">
                                         ...
                                         <select type="date" name="id_paket" id="id_paket" class="form-control">
                                     ...
                                     <div class="form-group">
                                         ...
                                         <select type="date" name="id_outlet" id="id_outlet" class="form-control">
                                     ...
                                     <a class="btn btn-primary" href="<?php echo base_url('laporan/exportToPdf/')  ?>"><i class="fa fa-print"></i></a>
