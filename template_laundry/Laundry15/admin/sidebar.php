    ...
    <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="index.php?page=barang">Outlet</a>
                <a class="collapse-item" href="index.php?page=kategori">Paket</a>
                <a class="collapse-item" href="index.php?page=kategori">Pelanggan</a>
                <a class="collapse-item" href="index.php?page=kategori">Pengguna</a>
    ...
    <li class="nav-item active">
        ...
        <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="index.php?page=laporan">Laporan </a>
            </div>
        </div>
    </li>
    <hr class="sidebar-divider">
