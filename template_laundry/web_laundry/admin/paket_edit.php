...
$edit 		= ambilsatubaris($koneksi,$queryedit);
			  var_dump($edit);
...
$query = "UPDATE paket SET nama_member = '$nama', jenis_paket = '$jenis_paket', harga='$harga', outlet_id = '$outlet_id' WHERE id_paket = '$id_paket'";
